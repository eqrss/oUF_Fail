...
local channelingTicks = {
	-- warlock
	[C_Spell.GetSpellInfo(234153)] = 6, -- Drain Life
	-- druid
	[C_Spell.GetSpellInfo(740)] = 4, -- Tranquility
	-- priest
    [C_Spell.GetSpellInfo(15407)] = 4, -- Mind Flay
--	[GetSpellInfo(48045)] = 6, -- Mind Sear
	[C_Spell.GetSpellInfo(47540)] = 3, -- Penance
	-- mage
	[C_Spell.GetSpellInfo(5143)] = 5, -- arcane missiles
	[C_Spell.GetSpellInfo(12051)] = 3, -- evocation
    -- monk
    [C_Spell.GetSpellInfo(115175)] = 8, -- soothing mist
    [C_Spell.GetSpellInfo(113656)] = 5, -- fists of fury
}
